...
Xavier {\sc Loizeau}\footnote{\label{HD}Ruprecht-Karls-Universität Heidelberg ;},\\ Joint work with Fabienne {\sc Comte}\footnote{Université Paris Descartes.} and Jan {\sc Johannes}\cref{HD}\\[1ex]
