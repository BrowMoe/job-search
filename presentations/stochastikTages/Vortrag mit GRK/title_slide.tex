...
\definecolor{bondiblue}{rgb}{0.0, 0.48, 0.71} %unused
\definecolor{mannheimgreen}{HTML}{418986} %these two colours come from `mannheim-logo.png'
\definecolor{mannheimblue}{HTML}{002f55}
...
\node[anchor=south west] 
  at ([yshift = 9pt,xshift=0.28cm]current page.south west) (logo)
...
%insert title, author, supervisor
\title{Title}
